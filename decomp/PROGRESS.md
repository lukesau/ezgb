...
|---|---|---|---|---|---|---|
| `Call_000_1a77` | 0 | `$1a77` | `$1a5e` | `src/misc.c` (`return_zero`) | Unconfirmed, called from bank_003, bank_007, bank_009, context not yet examined | Matched, both versions |

Total matched: 1 function, 3 bytes.
