#!/usr/bin/env python3
"""Interior-label naming packet, for the phase after notes.json CF is complete.
...
# RGBDS builtins that must not be used as label names (a subset; extend if make fails).
RGBDS_RESERVED = {
