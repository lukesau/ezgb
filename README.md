...
| **Version on HELP tab** | The HELP screen shows the mod version (e.g. `MOD 3.18`) under the URL, so you can tell which build a card is running. Stamp it with `scripts/stamp-mod-version.sh`. | — |
